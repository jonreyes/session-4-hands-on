      ...
      (function() {
        ...
        function updateFunctionComponent(current2, workInProgress2, Component4, nextProps, renderExpirationTime2) {
          ...
          prepareToReadContext(workInProgress2, renderExpirationTime2);
          {
            ReactCurrentOwner$1.current = workInProgress2;
            setIsRendering(true);
            nextChildren = renderWithHooks(current2, workInProgress2, Component4, nextProps, context, renderExpirationTime2);
            if (workInProgress2.mode & StrictMode) {
              if (workInProgress2.memoizedState !== null) {
                nextChildren = renderWithHooks(current2, workInProgress2, Component4, nextProps, context, renderExpirationTime2);
              }
        ...
        function mountIndeterminateComponent(_current, workInProgress2, Component4, renderExpirationTime2) {
          ...
          var value;
          {
            ...
            setIsRendering(true);
            ReactCurrentOwner$1.current = workInProgress2;
            value = renderWithHooks(null, workInProgress2, Component4, props, context, renderExpirationTime2);
            setIsRendering(false);
          }
          workInProgress2.effectTag |= PerformedWork;
...
For more info, visit https://fb.me/react-mock-scheduler`);
  ...
  class VideoButton extends React2.Component {
    render() {
      ...
      }, React2.createElement("h4", null, videoTitle), React2.createElement("p", null, videoDescription)));
    }
  }
  const VideoButton_default = VideoButton;

  // src/VideoList.js
  const React3 = __toModule(require_react());
  class VideoList extends React3.Component {
    render() {
      var {
        videos,
        selectedVideoIndex
      ...
      return React3.createElement("div", {
        ...
        return React3.createElement(VideoButton_default, {
          key: `${id}-${index}`,
          videoTitle: title,
          videoImage: img,
  ...
  const VideoList_default = VideoList;
  ...
  const VideoPlayer_default = VideoPlayer2;

  // src/App.js
  const React = __toModule(require_react());
  const ReactDOM = __toModule(require_react_dom());
  ReactDOM.render(React.createElement(VideoPlayer_default, null), document.getElementById("root"));
})();
