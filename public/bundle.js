...
For more info, visit https://fb.me/react-mock-scheduler`);
  ...
  const App = (props) => {
    ...
    }, "-", props.incrementAmount), React.createElement("span", null, count), React.createElement("button", {
      onClick: incrementCount
    }, "+", props.incrementAmount), React.createElement("br", null), React.createElement("br", null), React.createElement("button", {
      onClick: resetCount
    }, "Reset"));
  };
